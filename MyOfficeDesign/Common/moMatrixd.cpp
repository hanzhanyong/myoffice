...
// now compile up Matrix via Matrixd
...
Matrixd::Matrixd( value_type a00, value_type a01, value_type a02, value_type a03,
...
void Matrixd::set( value_type a00, value_type a01, value_type a02, value_type a03,
				  value_type a10, value_type a11, value_type a12, value_type a13,
				  value_type a20, value_type a21, value_type a22, value_type a23,
				  value_type a30, value_type a31, value_type a32, value_type a33)
{
...
int Matrixd::compare(const Matrixd& m) const
{
...
void Matrixd::setTrans( const Vec3f& v )
{
	_mat[3][0] = v[0];
	_mat[3][1] = v[1];
	_mat[3][2] = v[2];
}
void Matrixd::setTrans( const Vec3d& v )
{
	_mat[3][0] = v[0];
	_mat[3][1] = v[1];
	_mat[3][2] = v[2];
...
void Matrixd::makeScale( const Vec3f& v )
{
	makeScale(v[0], v[1], v[2] );
}

void Matrixd::makeScale( const Vec3d& v )
{
	makeScale(v[0], v[1], v[2] );
}
...
void Matrixd::makeTranslate( const Vec3f& v )
{
	makeTranslate( v[0], v[1], v[2] );
}

void Matrixd::makeTranslate( const Vec3d& v )
{
	makeTranslate( v[0], v[1], v[2] );
}
...
void Matrixd::makeRotate( const Vec3f& from, const Vec3f& to )
{
	makeIdentity();
...
void Matrixd::makeRotate( const Vec3d& from, const Vec3d& to )
{
	makeIdentity();
...
void Matrixd::makeRotate( value_type angle, const Vec3f& axis )
{
	makeIdentity();
...
void Matrixd::makeRotate( value_type angle, const Vec3d& axis )
{
	makeIdentity();
...
void Matrixd::makeRotate( value_type angle, value_type x, value_type y, value_type z ) 
{
	makeIdentity();
...
void Matrixd::makeRotate( const Quat& quat )
{
	makeIdentity();
...
void Matrixd::makeRotate( value_type angle1, const Vec3f& axis1, 
...
void Matrixd::makeRotate( value_type angle1, const Vec3d& axis1, 
...
void Matrixd::orthoNormalize(const Matrixd& rhs)
{
...
void Matrixd::makeOrtho(double left, double right,
						double bottom, double top,
						double zNear, double zFar)
{
	// note transpose of Matrixd wr.t OpenGL documentation, since the  use post multiplication rather than pre.
...
bool Matrixd::getOrtho(double& left, double& right,
					   double& bottom, double& top,
...
void Matrixd::makeFrustum(double left, double right,
						  double bottom, double top,
						  double zNear, double zFar)
{
	// note transpose of Matrixd wr.t OpenGL documentation, since the  use post multiplication rather than pre.
...
bool Matrixd::getFrustum(double& left, double& right,
						 double& bottom, double& top,
						 double& zNear, double& zFar) const
{
...
void Matrixd::makePerspective(double fovy,double aspectRatio,
							  double zNear, double zFar)
{
...
bool Matrixd::getPerspective(double& fovy,double& aspectRatio,
							 double& zNear, double& zFar) const
{
	double right  =  0.0;
	double left   =  0.0;
...
void Matrixd::makeLookAt(const Vec3d& eye,const Vec3d& center,const Vec3d& up)
{
	Vec3d f(center-eye);
	f.normalize();
	Vec3d s(f^up);
...
void Matrixd::getLookAt(Vec3f& eye,Vec3f& center,Vec3f& up,value_type lookDistance) const
{
	Matrixd inv;
	inv.invert(*this);
...
void Matrixd::getLookAt(Vec3d& eye,Vec3d& center,Vec3d& up,value_type lookDistance) const
{
	Matrixd inv;
	inv.invert(*this);
