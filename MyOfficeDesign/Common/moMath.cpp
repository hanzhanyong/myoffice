...
double MyOffice::asciiToDouble(const char* str)
{
    const char* ptr = str;
    ...
    if (strncmp(ptr,"0x",2)==0)
    {
        ...
        // NOTICE<<"Read "<<str<<" result = "<<value<<std::endl;
        return value;
    }
    ...
    if (pos==0)
    {
        // NOTICE<<"Read "<<str<<" result = "<<value[0]*sign[0]<<std::endl;
    ...
    else
    {
        ...
        //NOTICE<<"Read "<<str<<" mantissa = "<<mantissa<<" exponent="<<exponent<<" result = "<<mantissa*pow(10.0,exponent)<<std::endl;
        return mantissa*pow(10.0,exponent);
    }
}

double MyOffice::findAsciiToDouble(const char* str)
{
   const char* ptr = str;
   double value = 0.0;
